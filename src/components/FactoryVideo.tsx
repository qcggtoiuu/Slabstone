      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative aspect-video rounded-xl overflow-hidden shadow-2xl">
          {window.innerWidth > 768 ? (
            <>
              {!isPlaying && (
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  <motion.div
                    className="text-center z-10 mb-8 w-full px-4"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.3 }}
                  >
                    <div className="max-w-[280px] mx-auto">
                      <h3 className="text-xl md:text-3xl font-bold text-white mb-4 tracking-wide drop-shadow-lg">
                        Ấn nút Play để
                      </h3>
                      <p className="text-lg md:text-2xl font-semibold text-white tracking-wider bg-black/30 px-4 py-2 rounded-full shadow-lg">
              ...
              <iframe
                ...
                src={`https://www.youtube.com/embed/PDYhwdNi_5Y${isPlaying ? "?autoplay=1" : "?controls=0"}`}
            ...
            <iframe
              className="w-full h-full aspect-video"
              src="https://www.youtube.com/embed/PDYhwdNi_5Y"
              title="Factory Introduction"
              frameBorder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
