      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Ghé thăm showroom SLABSTONE để trải nghiệm trực tiếp các sản phẩm đá
            cao cấp và nhận tư vấn từ đội ngũ chuyên viên của chúng tôi.
          </p>
        </div>
          ...
          {showrooms.map((showroom, index) => (
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <h3 className="text-xl font-bold">{showroom.city}</h3>
